...
Weapon::Weapon(int damageMin, int damageMax, std::string name, int level, int buyValue, int sellvalue, int rarity) :  Item(itemTypes::WEAPON, name, level, buyValue, sellvalue, rarity) {
